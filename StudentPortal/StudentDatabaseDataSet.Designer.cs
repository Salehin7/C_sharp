...
namespace StudentPortal {
    ...
    public partial class StudentDatabaseDataSet : global::System.Data.DataSet {
        ...
        public partial class StudentDataTable : global::System.Data.TypedTableBase<StudentRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public StudentRow AddStudentRow(string Name, string Email, string Phone, string Address, byte[] Image) {
...
namespace StudentPortal.StudentDatabaseDataSetTableAdapters {
    ...
    public partial class StudentTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `Student` WHERE ((`ID` = ?) AND ((? = 1 AND `Name` IS NULL) OR (`Name" +
                "` = ?)) AND ((? = 1 AND `Email` IS NULL) OR (`Email` = ?)) AND ((? = 1 AND `Phon" +
                "e` IS NULL) OR (`Phone` = ?)) AND ((? = 1 AND `Address` IS NULL) OR (`Address` =" +
                " ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Student` (`Name`, `Email`, `Phone`, `Address`, `Image`) VALUES (?, ?" +
                ", ?, ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `Student` SET `Name` = ?, `Email` = ?, `Phone` = ?, `Address` = ?, `Image` = ? WHERE ((`ID` = ?) AND ((? = 1 AND `Name` IS NULL) OR (`Name` = ?)) AND ((? = 1 AND `Email` IS NULL) OR (`Email` = ?)) AND ((? = 1 AND `Phone` IS NULL) OR (`Phone` = ?)) AND ((? = 1 AND `Address` IS NULL) OR (`Address` = ?)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::StudentPortal.Properties.Settings.Default.StudentDatabaseConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Name, Email, Phone, Address, [Image] FROM Student";
        ...
        public virtual int Insert(string Name, string Email, string Phone, string Address, byte[] Image) {
            if ((Name == null)) {
        ...
        public virtual int Update(string Name, string Email, string Phone, string Address, byte[] Image, int Original_ID, string Original_Name, string Original_Email, string Original_Phone, string Original_Address) {
            if ((Name == null)) {
